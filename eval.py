...
if __name__ == '__main__':
    ...
    if args.use_no_element == False:
        ax.matshow(confusion_matrix, aspect='auto', vmin=0, vmax=1600, cmap=plt.get_cmap('Blues'))
        ...
        plt.savefig(save_dir + 'coordinates_figure_12_upper_3.png')

    else:
        ax.matshow(confusion_matrix, aspect='auto', vmin=0, vmax=12000, cmap=plt.get_cmap('Blues'))
        plt.ylabel('Actual Category')
        ...
        save_dir = '/home/akiho/projects/stsqdb_op/'
        plt.savefig(save_dir + 'coordinates_figure_13_upper_3.png')